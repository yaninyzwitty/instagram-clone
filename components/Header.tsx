...
function Header() {
    ...
    // see the useReadOnly from recoil.js 💢💌💥
  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
        ...
        {session ? (
            ...
            <div className="absolute -top-3 -right-2 text-sm w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse text-white">3</div>
            </div>
            <PlusCircleIcon 
